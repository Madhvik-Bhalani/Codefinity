            ...
            <div className="container">
                <div className="text-center mb-5">
                    ...
                    <p className='mt-3 mb-2'> 
                        ...
                        to continuous learning and development, we’re building projects that make a difference in the world of AI.
                    </p>
                </div>
                <div className="row">
                    {/* Vision */}
                        ...
                        <div className="card border-0 shadow-sm">
                            <div className="card-body">
                                <div className="d-flex align-items-center mb-3">
                                    <i className="fas fa-eye fs-1 text-primary me-3"></i>
                    ...
                    <div className="col-md-6 mb-4">
                        <div className="card border-0 shadow-sm">
                            <div className="card-body">
                                <div className="d-flex align-items-center mb-3">
                                    <i className="fas fa-bullseye fs-1 text-primary me-3"></i>

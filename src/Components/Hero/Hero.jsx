        ...
        <>
            <div className="hero" id="home">
                ...
                <div className="left">
                    ...
                    <div className="para">
                        <p>Welcome to <span style={{ textShadow: "0.25px 0.25px 0.25px #121b22" }}>Codefinity</span>, your hub for AI-driven solutions. As a team of passionate developers, we're building projects that push the boundaries of artificial intelligence. Join us as we explore new horizons in technology and make a difference in the digital world.
                        </p>
                    </div>
                    <div className="btns">
                        ...
                        }} onClick={clickHandler}>Get Started</button>
                    </div>
                </div>
